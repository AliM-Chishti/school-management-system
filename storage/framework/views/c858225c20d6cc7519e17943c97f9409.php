...
<?php $__env->startSection('page-title', 'Edit Admin Profile'); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('department', $user->department)); ?>">
...
unset($__errorArgs, $__bag); ?>" rows="4"><?php echo e(old('address', $user->address)); ?></textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="<?php echo e($user->status); ?>" disabled>
                                <small class="text-muted">Cannot be changed</small>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\SMS\resources\views/profile/edit.blade.php ENDPATH**/ ?>